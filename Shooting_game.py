...
#-----------사운드 로드 -----------
pygame.mixer.music.load("images/happytheme-22437.mp3")#배경음악 로드
pygame.mixer.music.play(-1) #배경음악 재생
mis_sound = pygame.mixer.Sound("images/gunshot-352466.mp3")
exp_sound = pygame.mixer.Sound("images/vine-boom-392646.mp3")
